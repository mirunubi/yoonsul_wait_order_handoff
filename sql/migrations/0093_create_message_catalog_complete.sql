...
(3005, 'feature_not_enabled',
  'SYSTEM', 'PERMISSION', 403, 'INFO', null),
...
(4006, 'refund_amount_exceeded',
  'PAYMENT', 'INVALID_INPUT', 400, 'ERROR', null),
...
(5003, 'allergen_not_declared',
  'MENU', 'BUSINESS_RULE', 422, 'CRITICAL',
  'SOP-FOOD-001'),
...
(6005, 'staff_quota_exceeded',
  'STAFF', 'CAPACITY', 429, 'WARNING', null),
...
(7010, 'push_token_invalid',
  'STORE', 'INVALID_INPUT', 400, 'WARNING', null),
...
(10002, 'evidence_packet_incomplete',
  'AUDIT', 'BUSINESS_RULE', 422, 'ERROR',
  'SOP-AUD-001'),
(10003, 'ledger_event_missing',
  'AUDIT', 'BUSINESS_RULE', 422, 'CRITICAL',
  'SOP-AUD-001')
