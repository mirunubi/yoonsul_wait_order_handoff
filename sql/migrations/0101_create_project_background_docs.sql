...
-- DEFERRED: this vision-document INSERT is truncated mid-generation
-- (opens $ko$ at original line 31, cuts off mid-sentence at
-- '## 5. 목표', no content_en, no closing clause). Original content
-- not recoverable from elsewhere in the repo. This is investor/
-- partner-facing business narrative content -- must be authored by a
-- human, not reconstructed by AI. Do not re-enable until the human
-- owner supplies the complete original text.
-- -- =============================================
-- -- 프로젝트 배경 문서 등록
-- -- =============================================
