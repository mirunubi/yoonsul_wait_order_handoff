# 040006_Policy_Korean_Food_Menu_Taxonomy_Seed_Registry_And_AI_Classification_Dictionary

## 1. Purpose

This document defines the Korean Food Menu Taxonomy Seed Registry and AI Classification Dictionary Policy.

The previous artifact `40004 AI Menu Category Context Two-Level Taxonomy And Classification Policy` defined the two-level taxonomy model:
...
- `40007 Korean Meat Grill Specialty Menu Taxonomy Policy`
