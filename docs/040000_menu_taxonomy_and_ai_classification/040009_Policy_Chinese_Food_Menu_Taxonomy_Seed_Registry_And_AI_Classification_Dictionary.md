# 040009_Policy_Chinese_Food_Menu_Taxonomy_Seed_Registry_And_AI_Classification_Dictionary

## 1. Purpose

This document defines the Chinese Food Menu Taxonomy Seed Registry and AI Classification Dictionary Policy.

The previous artifact `40008 Japanese Seafood Sushi Menu Taxonomy Seed Registry And AI Classification Dictionary Policy` expanded Japanese, sushi, sashimi, seafood, market-price, piece-count, omakase, and raw item classification.
...
- `40010 Western Asian Food Menu Taxonomy Policy`
- `40011 Cafe Dessert Beverage Menu Taxonomy Policy`
- `40012 Menu Cooking Time Default Matrix And Fast Track Eligibility Policy`
