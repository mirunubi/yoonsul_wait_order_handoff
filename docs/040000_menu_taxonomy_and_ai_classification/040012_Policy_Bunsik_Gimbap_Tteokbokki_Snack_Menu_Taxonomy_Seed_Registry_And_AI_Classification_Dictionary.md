# 040012_Policy_Bunsik_Gimbap_Tteokbokki_Snack_Menu_Taxonomy_Seed_Registry_And_AI_Classification_Dictionary
...
The previous artifact `40011 Chicken Pizza Fast Food Menu Taxonomy Seed Registry And AI Classification Dictionary Policy` expanded chicken, pizza, burger, fast food, side, sauce, drink, set, pack, and option-heavy menu classification.
...
- `40013 Cafe Dessert Beverage Menu Taxonomy Policy`
- `40014 Pub Bar Izakaya Alcohol Anju Menu Taxonomy Policy`
- `40015 Menu Cooking Time Default Matrix And Fast Track Eligibility Policy`
- `40016 Group Order Menu Batching And Pickup SLA Policy`
