# 040008_Policy_Japanese_Seafood_Sushi_Menu_Taxonomy_Seed_Registry_And_AI_Classification_Dictionary
...
The previous artifact `40007 Korean Meat Grill BBQ Menu Taxonomy Seed Registry And AI Classification Dictionary Policy` expanded the meat/grill category with gram unit, serving rule, first-order limit, set/refill, side meal, alcohol, POS, and inventory parsing boundaries.
