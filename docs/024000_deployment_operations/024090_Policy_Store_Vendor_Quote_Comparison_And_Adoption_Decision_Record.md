...
Example:
    ...
    OKPOS dealer \= POS\_DEALER \+ SUPPORT\_VENDOR
    Toss \= POS\_PROVIDER \+ PAYMENT\_PROVIDER \+ KIOSK\_PROVIDER
    PAYCO \= PAYMENT\_PROVIDER \+ SMART\_ORDER\_CHANNEL
    Small kiosk vendor \= KIOSK\_PROVIDER \+ possibly POS\_DEALER\_DEPENDENT
...
\- \`DRAFT\`
\- \`UNDER\_REVIEW\`
\- \`NEEDS\_VENDOR\_CONFIRMATION\`
\- \`NEEDS\_COST\_CONFIRMATION\`
\- \`NEEDS\_TECH\_CONFIRMATION\`
\- \`BLOCKED\`
\- \`SELECTED\_FOR\_FIRST\_STORE\`
\- \`SELECTED\_WITH\_CONDITIONS\`
\- \`REJECTED\`
\- \`DEFERRED\`
\- \`SUPERSEDED\`
