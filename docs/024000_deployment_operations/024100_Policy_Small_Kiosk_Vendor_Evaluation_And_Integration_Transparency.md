# 024100_Policy_Small_Kiosk_Vendor_Evaluation_And_Integration_Transparency
...
Temporary use must be marked:
    ...
    TEMPORARY\_OPERATIONAL\_VENDOR
...
\- \`QUOTE\_RECEIVED\`
\- \`DEMO\_ONLY\`
\- \`OPERATIONAL\_USE\_CANDIDATE\`
\- \`TEMPORARY\_OPERATIONAL\_VENDOR\`
\- \`INTEGRATION\_CANDIDATE\`
\- \`NEEDS\_TECH\_CONFIRMATION\`
\- \`NEEDS\_DEALER\_CONFIRMATION\`
\- \`NEEDS\_SUPPORT\_CONFIRMATION\`
\- \`BLOCKED\`
\- \`REJECTED\`
\- \`DEFERRED\`
