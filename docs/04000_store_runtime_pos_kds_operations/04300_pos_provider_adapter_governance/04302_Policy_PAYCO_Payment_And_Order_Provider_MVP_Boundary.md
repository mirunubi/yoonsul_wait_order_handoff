# 04302_Policy_PAYCO_Payment_And_Order_Provider_MVP_Boundary
...
```text
PAYMENT_AMOUNT_REVIEW_REQUIRED
```
...
```text
PROVIDER_EVENT_VERIFICATION_REQUIRED
```
...
payment_request
payment_event
provider_order_event
provider_customer_reference
provider_coupon_reference
...
```text
PAYCO_PAYMENT_REQUEST_CREATED
PAYCO_PROVIDER_EVENT_RECEIVED
PAYCO_PROVIDER_EVENT_VERIFIED
PAYCO_PAYMENT_DONE
PAYCO_PAYMENT_FAILED
PAYCO_PAYMENT_EXPIRED
PAYCO_ORDER_EVENT_RECEIVED
PAYCO_ORDER_NORMALIZED
PAYCO_COUPON_APPLIED
PAYCO_PROMOTION_APPLIED
PAYMENT_AMOUNT_MISMATCH
...
```text
PAYCO payment event can be verified and mapped to internal PAYMENT_DONE
