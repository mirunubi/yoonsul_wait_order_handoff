# 04304_Policy_OKPOS_And_Major_POS_Integration_Candidate
...
```text
POS_PROVIDER
ORDER_SOURCE_PROVIDER
PAYMENT_STATUS_SOURCE
TABLE_REFERENCE_SOURCE
RECEIPT_REFERENCE_SOURCE
...
```text
LEVEL_0_MANUAL_OR_NO_API
LEVEL_1_READ_ONLY_INTAKE
LEVEL_2_EVENT_SYNC
LEVEL_3_OPERATIONAL_AUTHORITY_INTEGRATION
LEVEL_4_CERTIFIED_DEEP_INTEGRATION
```
...
```text
EXTERNAL_ORDER_IDENTITY_INCOMPLETE
```
...
```text
CANCELLATION_MAPPING_UNCERTAIN
```
...
```text
POSADP-ORDER-001 external_order_id missing
