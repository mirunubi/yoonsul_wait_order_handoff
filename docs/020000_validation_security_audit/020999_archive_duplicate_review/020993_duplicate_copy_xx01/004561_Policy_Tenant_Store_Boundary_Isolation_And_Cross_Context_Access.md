# 004561_Policy_Tenant_Store_Boundary_Isolation_And_Cross_Context_Access
...
If Local Agent context is uncertain, local data must be marked `CACHE_STATE_UNCERTAIN`.
