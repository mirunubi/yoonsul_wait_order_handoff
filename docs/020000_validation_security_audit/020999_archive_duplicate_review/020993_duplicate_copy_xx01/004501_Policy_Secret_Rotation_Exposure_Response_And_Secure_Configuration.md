# 004501_Policy_Secret_Rotation_Exposure_Response_And_Secure_Configuration
...
Example allowed `.env.example` pattern:
    ...
    SUPABASE_ANON_KEY=replace_with_dummy_anon_key
    SUPABASE_SERVICE_ROLE_KEY=never_put_real_value_here
    PAYMENT_PROVIDER_SECRET=replace_with_dummy_secret
    WEBHOOK_SIGNING_SECRET=replace_with_dummy_secret
