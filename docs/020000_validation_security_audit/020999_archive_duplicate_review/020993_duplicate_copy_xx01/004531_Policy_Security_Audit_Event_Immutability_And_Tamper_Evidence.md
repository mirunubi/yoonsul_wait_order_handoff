# 004531_Policy_Security_Audit_Event_Immutability_And_Tamper_Evidence
...
- payment_reference where applicable and masked
...
- approval_reference where applicable
...
- source_ip or source network context where appropriate
- client_timestamp where applicable
- server_received_timestamp
- audit_appended_timestamp
- result
- failure_reason where applicable
- masking_status where applicable
...
- overwrite before_state
- overwrite after_state
...
- correction_actor
- correction_reason
- corrected_field_reference
- original_value_reference where safe
- corrected_value_reference where safe
