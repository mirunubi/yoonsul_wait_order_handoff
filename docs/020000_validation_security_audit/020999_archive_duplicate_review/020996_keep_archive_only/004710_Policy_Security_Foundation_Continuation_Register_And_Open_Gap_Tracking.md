# 004710_Policy_Security_Foundation_Continuation_Register_And_Open_Gap_Tracking
...
\- \`TEST\_REQUIRED\`
\- \`EVIDENCE\_REQUIRED\`
\- \`VENDOR\_REVIEW\_REQUIRED\`
\- \`TRAINING\_REQUIRED\`
\- \`INCIDENT\_RUNBOOK\_REQUIRED\`
\- \`COMPLIANCE\_MAPPING\_REQUIRED\`
\- \`SECURITY\_EXCEPTION\`
\- \`DEFERRED\_DECISION\`
\- \`IMPLEMENTATION\_BLOCKER\`
\- \`REVIEW\_REQUIRED\`
...
\- \`OPEN\`
\- \`IN\_REVIEW\`
\- \`MAPPED\_TO\_DOCUMENT\`
\- \`MAPPED\_TO\_IMPLEMENTATION\`
\- \`BLOCKING\`
\- \`DEFERRED\_WITH\_REASON\`
