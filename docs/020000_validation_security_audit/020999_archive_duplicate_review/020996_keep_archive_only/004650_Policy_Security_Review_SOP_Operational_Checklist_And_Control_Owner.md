# 004650_Policy_Security_Review_SOP_Operational_Checklist_And_Control_Owner
...
\- tenant\_id is present where required
\- store\_id is present where required
