...
| Previous Gate | 064300_Checklist_Flow_Bundle_Code_Handoff_Readiness_Gate.md |
...
| Flow Document | Scope |
|---|---|
| 064100_Flow_POS_Gateway_Approval_To_Audit_Ledger_And_Reconciliation.md | Approval to audit ledger and reconciliation |
| 064110_Flow_POS_Gateway_Cancel_Refund_Recovery_And_Audit.md | Cancel, refund, recovery, and audit |
| 064120_Flow_POS_Gateway_Timeout_Retry_DLQ_And_Replay.md | Timeout, retry, DLQ, and replay |
| 064130_Flow_POS_Gateway_Store_Offline_Local_Ledger_And_Resync.md | Store offline local ledger and resync |
| 064140_Flow_POS_Gateway_Webhook_Inbound_Verification_And_Event_Normalization.md | Webhook verification and event normalization |
| 064150_Flow_POS_Gateway_Settlement_Dispute_And_Evidence_Export.md | Settlement, dispute, and evidence export |

This template may also be reused for future 64000-band Flow Bundles.
...
1. 064000_Index_Runtime_Flow_Bundle_Registry.md
2. 064300_Checklist_Flow_Bundle_Code_Handoff_Readiness_Gate.md
3. {{FLOW_BUNDLE_DOCUMENT}}
4. 064200_Matrix_Flow_To_MD_Dependency_Graph.md
5. 064210_Matrix_Flow_To_Module_Implementation_Map.md
6. 064220_Matrix_Flow_To_Test_Coverage_Map.md
...
|---|---|
| 064000_Index_Runtime_Flow_Bundle_Registry.md | Registry index |
| 064100_Flow_POS_Gateway_Approval_To_Audit_Ledger_And_Reconciliation.md | Approval flow |
| 064110_Flow_POS_Gateway_Cancel_Refund_Recovery_And_Audit.md | Cancel/refund flow |
| 064120_Flow_POS_Gateway_Timeout_Retry_DLQ_And_Replay.md | Timeout/retry/replay flow |
| 064130_Flow_POS_Gateway_Store_Offline_Local_Ledger_And_Resync.md | Offline/local ledger flow |
| 064140_Flow_POS_Gateway_Webhook_Inbound_Verification_And_Event_Normalization.md | Webhook normalization flow |
| 064150_Flow_POS_Gateway_Settlement_Dispute_And_Evidence_Export.md | Settlement/dispute/evidence flow |
...
| 064300_Checklist_Flow_Bundle_Code_Handoff_Readiness_Gate.md | Pre-code handoff gate |
