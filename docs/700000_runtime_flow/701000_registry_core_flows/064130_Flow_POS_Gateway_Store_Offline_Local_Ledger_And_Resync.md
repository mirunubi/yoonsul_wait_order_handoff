...
This document establishes `064130_Flow_POS_Gateway_Store_Offline_Local_Ledger_And_Resync.md` as the controlled Flow Bundle for offline store operation, local temporary ledger handling, central resynchronization, conflict quarantine, and audit evidence generation.
