# 04991_Audit_Append_Only_Evidence_And_Tamper_Resistance_Test_Catalog
...
- Audit event attempt lacks actor_id or service identity.
...
### TC-AUDIT-005-APPEND_ONLY: Audit Event Cannot Be Updated In Place
...
### TC-AUDIT-006-APPEND_ONLY: Audit Event Cannot Be Deleted
...
### TC-AUDIT-007-APPEND_ONLY: Correction Creates New Audit Event
...
### TC-AUDIT-008-APPEND_ONLY: Superseded State Keeps Original History
...
- Audit event records fallback_originated status, actor/device, store, and evidence link.
...
- Audit includes created_at and occurred_at where applicable.
