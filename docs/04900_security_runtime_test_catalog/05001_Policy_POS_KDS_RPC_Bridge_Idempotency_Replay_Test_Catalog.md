...
- RPC request lacks tenant_id or trusted derived tenant context.
...
- RPC request lacks store_id or trusted derived store context.
...
- Event has fallback_originated marker.
