...
The detailed state machine is defined in `docs/09000_data_model_state_machine/09020_Handoff_State_Machine.md`.
...
Entrance waiting assist device SOP may reduce web/app friction for phone-number-based waiting registration and optional preorder continuation; see `05060_SOP_Entrance_Waiting_Assist_Device_Operation.md`.
