...
- `PHASE2_POS_OPEN_API_CANDIDATE`
- `PHASE2_PAYMENT_ONLY_CANDIDATE`
- `PHASE2_SMART_ORDER_CHANNEL`
- `PHASE2_HARDWARE_CERTIFIED_ONLY`
- `PHASE2_PARTNER_ACCESS_REQUIRED`
- `PHASE2_DOCUMENTATION_ONLY`
- `PHASE2_NOT_RECOMMENDED`
