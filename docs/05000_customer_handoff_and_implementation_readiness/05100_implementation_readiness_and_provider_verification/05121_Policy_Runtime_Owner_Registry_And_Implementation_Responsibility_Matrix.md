...
Before a backlog item moves to `READY_FOR_IMPLEMENTATION`, the runtime owner must confirm:
...
- `BLOCKED_BY_SECURITY`
- `BLOCKED_BY_EVIDENCE`
- `BLOCKED_BY_VENDOR_DOCS`
- `READY_FOR_IMPLEMENTATION`
- `READY_FOR_RELEASE_GATE`
- `DEFERRED`
- `REMOVED_FROM_SCOPE`

No critical runtime may enter implementation with `OWNER_NOT_ASSIGNED` or `BACKUP_NOT_ASSIGNED`.
