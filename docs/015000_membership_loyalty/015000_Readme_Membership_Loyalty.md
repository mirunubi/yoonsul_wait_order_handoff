...
Existing `docs/28000_future_expansion/028020_Membership_Loyalty_Point_Future_Model.md` and `docs/28000_future_expansion/028030_Boundary_Point_Bridge_And_Exchange_Future.md` remain historical/future context in `28000` until a separate migration is approved.
