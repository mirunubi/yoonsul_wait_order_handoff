# 011010_Boundary_POS_Payment_Printer_Integration
...
Integration levels must align with `docs/03000_saas_runtime/003010_Tenant_Store_Runtime_And_Package_Model.md`.
...
- POS API truth boundary is refined in `docs/11000_integration_boundary/011020_Boundary_POS_API_Integration_Truth.md`.
- Printer/Store Agent boundary is refined in `docs/11000_integration_boundary/011030_Boundary_Printer_And_Store_Agent.md`.
- Payment/financial truth boundary is refined in `docs/11000_integration_boundary/011040_Boundary_Payment_And_Financial_Truth.md`.
- Manual POS input/reconciliation boundary is refined in `docs/11000_integration_boundary/011050_Boundary_Manual_POS_Input_And_Reconciliation.md`.
- Failure/retry/recovery boundary is refined in `docs/11000_integration_boundary/011060_Boundary_Integration_Failure_Retry_And_Recovery.md`.
