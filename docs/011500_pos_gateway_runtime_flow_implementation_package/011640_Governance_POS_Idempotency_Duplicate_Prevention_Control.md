...
Defines idempotency and duplicate prevention controls for POS runtime flow.
...
- Documentation-only artifact for the `POS Idempotency And Duplicate Prevention` group.
