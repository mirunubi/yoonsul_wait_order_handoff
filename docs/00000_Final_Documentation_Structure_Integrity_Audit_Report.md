# 00000_Final_Documentation_Structure_Integrity_Audit_Report
...
| `00000_Top_Level_Folder_Consolidation_Plan.md` | Consolidation plan |
...
| `40000` | `40000_Menu_Taxonomy_..._Readme.md` · `40000_Menu_Taxonomy_Wave_5_Review_Report.md` | Audit report + readme (acceptable) |
...
| --- | --- | --- |
| `04400_Toss_Payments_MVP_Integration_Boundary_Policy.md` | `11000_integration_boundary/` | `04000/.../04300_pos_provider_adapter_governance/` |
| `04410_PAYCO_Payment_And_Order_Provider_MVP_Boundary_Policy.md` | `11000_integration_boundary/` | `04000/.../04300_pos_provider_adapter_governance/` |
| `04420_POS_Adapter_Runtime_Data_Object_And_Event_Family_Policy.md` | `11000_integration_boundary/` | `04000/.../04300_pos_provider_adapter_governance/` |
| `04430_OKPOS_And_Major_POS_Integration_Candidate_Policy.md` | `11000_integration_boundary/` | `04000/.../04300_pos_provider_adapter_governance/` |
| `04450_POS_RPC_Communication_Security_And_Provider_Trust_Boundary_Policy.md` | `20000_validation_security_audit/` | `04000/.../04300_pos_provider_adapter_governance/` |
| `04460_POS_Webhook_Signature_Secret_Rotation_And_Credential_Isolation_Policy.md` | `20000_validation_security_audit/` | `04000/.../04300_pos_provider_adapter_governance/` |
...
| `10000_10712_Root_File_Rename_And_Move_Plan.md` | — | Contains `docs/10700_security_trust_and_menu_intelligence/` historical targets (**expected archive**) |
...
| File | Package |
| --- | --- |
| `10720_Privacy_Consent_Evidence_Packet_And_Retention_Policy.md` | `40000_menu_taxonomy_and_ai_classification` |
| `10720_Legal_Notice_SOP_And_Regulatory_Control_Readme.md` | `10000/10720_legal_notice_sop_and_regulatory_control` |
