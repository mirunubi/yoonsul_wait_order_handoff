# 04040 Admin Screen Inventory And Navigation Model
...
Surface state visibility is defined in `docs/07000_app_api_projection/07060_Surface_State_Visibility_And_Authority_Matrix.md`.

Customer wording matrix is defined in `docs/07000_app_api_projection/07070_Customer_Surface_State_Wording_Matrix.md`.

Store/admin/support action authority is defined in `docs/07000_app_api_projection/07080_Store_Admin_Support_Action_Authority_Matrix.md`.
