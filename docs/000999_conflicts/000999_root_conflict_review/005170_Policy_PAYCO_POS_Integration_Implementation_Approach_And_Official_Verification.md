# 005170_Policy_PAYCO_POS_Integration_Implementation_Approach_And_Official_Verification
...
- PAYCO Android guide requires `INTERNET` permission and `ACCESS_NETWORK_STATE` permission for login SDK.
...
5. **PAYCO Payment Backend Lane**
   ...
   - SellerKey / client_secret handling
...
- Client app must not store SellerKey, client_secret, payment approval secrets, or server-side credentials.
...
- PAYCO_ORDER_RESERVATION_REQUESTED
- PAYCO_ORDER_RESERVATION_CREATED
- PAYCO_PAYMENT_UI_OPENED
- PAYCO_AUTH_CALLBACK_RECEIVED
- PAYCO_AUTH_CALLBACK_VALIDATED
- PAYCO_APPROVAL_REQUESTED
- PAYCO_PAYMENT_APPROVED
- PAYCO_PAYMENT_FAILED
- PAYCO_PAYMENT_CANCELLED
- PAYCO_PAYMENT_RECONCILIATION_REQUIRED
...
- payco_seller_key_reference
- payco_merchant_id where applicable
- payco_partner_id where applicable
- payco_order_channel
- payco_store_identifier
- tenant_id
- store_id
...
- client_secret must be reviewed before client use.
...
- PAYCO_CANCEL_REQUESTED
- PAYCO_CANCEL_CALLBACK_RECEIVED
- PAYCO_CANCEL_APPROVED
- PAYCO_CANCEL_FAILED
- PAYCO_REFUND_REVIEW_REQUIRED
- PAYCO_KDS_CANCEL_MISMATCH
- PAYCO_SETTLEMENT_RECONCILIATION_REQUIRED
...
7. client_id/client_secret handling.
...
- storing client_secret in WebView or local storage without review
...
- SellerKey and client_secret must not leak
