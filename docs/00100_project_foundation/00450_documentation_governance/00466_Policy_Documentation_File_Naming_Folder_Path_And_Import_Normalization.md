...
The recommended filename format is:
    ...
    {document_number}_{Title_In_Pascal_Underscore}.md

Example:

    00465_Policy_Documentation_File_Naming_Folder_Path_And_Import_Normalization.md
...
The H1 title should follow:
    ...
    # {document_number} {Document Title}
...
- `04750_temp.md`
- `mobile_draft_04750.md`
- `unsorted_04750.md`
- `google_docs_import_04750.md`
...
Examples:
    ...
    docs/security_foundation/
    docs/pos_kds_security/
    docs/degraded_recovery/
    docs/payment_boundary/
    docs/support_access/
    docs/documentation_governance/
    docs/implementation_mapping/
    docs/testing_verification/
...
Examples:
    ...
    05xxx_Security_Incident_Response_Store_Operator_SOP.md
...
Recommended pattern:
    ...
    {number}_{Runtime_Or_Feature}_Implementation_Security_Mapping.md

Examples:

    05xxx_POS_KDS_RPC_Implementation_Security_Mapping.md
    05xxx_Supabase_RLS_Tenant_Store_Implementation_Mapping.md
    05xxx_Payment_Webhook_Refund_Implementation_Security_Mapping.md
...
Recommended pattern:
    ...
    {number}_{Feature_Or_Lane}_Security_Test_Catalog.md

Examples:

    05xxx_POS_KDS_RPC_Security_Test_Catalog.md
    05xxx_Payment_Webhook_Idempotency_And_Replay_Test_Catalog.md
    05xxx_Tenant_Store_Isolation_RLS_Test_Catalog.md
...
Recommended pattern:
    ...
    {number}_{Control_Area}_Evidence_Register.md

Examples:

    05xxx_Payment_Boundary_Evidence_Register.md
    05xxx_CI_DI_Protection_Evidence_Register.md
    05xxx_Support_Access_Break_Glass_Evidence_Register.md
...
Recommended patterns:
    ...
    {range}_Index_And_Readiness_Check.md
    {lane}_Document_Index.md
    {lane}_Coverage_Index.md

Examples:

    04700_Policy_Security_Foundation_Final_Index_And_Next_Phase_Handoff.md
    00463_Policy_Documentation_Lane_Coverage_Matrix_And_Missing_Document_Detection.md
...
Recommended pattern:
    ...
    {number}_{Lane_Or_Feature}_Index_And_Readiness_Check.md

or:

    {number}_{Lane_Or_Feature}_Readiness_Gate.md
