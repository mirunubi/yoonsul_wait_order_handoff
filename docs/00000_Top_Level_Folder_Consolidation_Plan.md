...
<< docs-only · folder architecture plan · Wave 1 applied >>
...
| `docs/05000_customer_handoff_flow/` | 6 | 0 | 6 | 05000 | Customer handoff flow | flat |
| `docs/05100_implementation_readiness_and_provider_verification/` | 12 | 0 | 12 | 05100 | Implementation readiness / provider verification | flat |
| `docs/05200_pos_payment_provider_and_kiosk_reuse/` | 7 | 0 | 7 | 05200 | POS payment provider / kiosk reuse | flat |
...
- **~350+ table rows** use paths under affected folders (sections 8–11, 19–20, 31–40 per current index).
...
| **Wave 4** | 13000 consolidation | 2–3 → under `13000_pos_provider_integration_strategy` | ~61+ | **User decision** on `13000_app_api_projection`; dedupe plan for overlaps |
