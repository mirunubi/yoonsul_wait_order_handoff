...
## Purpose
This document defines the boundary that keeps data model planning separate from runtime implementation for the Data Model Governance group in Batch 7I.
