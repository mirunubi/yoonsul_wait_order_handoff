# 02010 Tenant Store Runtime And Package Model
...
Membership/point is deferred to `docs/09000_future_expansion/09020_Membership_Loyalty_Point_Future_Model.md` and `docs/09000_future_expansion/09030_Point_Bridge_And_Exchange_Future_Boundary.md`.
...
Admin Console role/context handling is defined in `docs/04000_admin_console/04010_Admin_Console_Context_And_Role_Model.md`.

Store runtime configuration handling is defined in `docs/04000_admin_console/04020_Admin_Store_Runtime_Configuration_Model.md`.

Operational monitoring/recovery visibility is defined in `docs/04000_admin_console/04030_Admin_Operational_Monitoring_And_Recovery_Model.md`.

Admin screen inventory is defined in `docs/04000_admin_console/04040_Admin_Screen_Inventory_And_Navigation_Model.md`.

Admin approval workflow is defined in `docs/04000_admin_console/04050_Admin_Approval_Workflow_Model.md`.

Admin audit/recovery queue governance is defined in `docs/04000_admin_console/04060_Admin_Audit_And_Recovery_Queue_Governance.md`.
