# 13070_Matrix_Customer_Surface_State_Wording
...
See also `docs/15000_membership_loyalty/15010_Boundary_Membership_Loyalty_Product.md` and `docs/15000_membership_loyalty/15050_Membership_Admin_And_UI_Reserved_Surface.md`.
