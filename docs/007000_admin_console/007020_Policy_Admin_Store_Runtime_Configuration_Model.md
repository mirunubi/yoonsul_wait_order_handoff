...
Package plans align with `docs/03000_saas_runtime/003010_Tenant_Store_Runtime_And_Package_Model.md`.
...
Admin store runtime configuration must follow `docs/03000_saas_runtime/003030_Store_Runtime_Profile_Model.md`, `docs/03000_saas_runtime/003040_Governance_Package_Plan_And_Feature_Flag_Runtime.md`, and `docs/03000_saas_runtime/003050_Governance_Runtime_Profile_Change_And_Audit.md`.
...
- Runtime profile configuration governance is defined in `docs/07000_admin_console/007080_Governance_Admin_Runtime_Profile_Configuration.md`.
- Feature flag approval/emergency disable is defined in `docs/07000_admin_console/007090_Admin_Feature_Flag_Approval_And_Emergency_Disable_Model.md`.
- Runtime profile change/audit must align with `docs/03000_saas_runtime/003050_Governance_Runtime_Profile_Change_And_Audit.md`.
- Admin visibility does not equal activation authority.
