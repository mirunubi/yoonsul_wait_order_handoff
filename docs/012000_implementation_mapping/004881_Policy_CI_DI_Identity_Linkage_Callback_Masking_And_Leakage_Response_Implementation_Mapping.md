# 004881_Policy_CI_DI_Identity_Linkage_Callback_Masking_And_Leakage_Response_Implementation_Mapping
...
- customer_session_id
- customer_account_id where applicable
- provider_name
...
- `IDENTITY_VERIFIED`
- `IDENTITY_LINKED`
- `IDENTITY_LINKAGE_REVIEW_REQUIRED`
- `IDENTITY_DUPLICATE_CANDIDATE`
- `IDENTITY_CORRECTION_REQUIRED`
- `IDENTITY_PROVIDER_UNCERTAIN`
- `IDENTITY_LEAKAGE_REVIEW_REQUIRED`
