# 004840_Policy_Tenant_Store_Context_RLS_And_Access_Control_Implementation_Mapping
...
\- actor\_type
\- actor\_role
\- actor\_affiliation\_id
\- company\_id where applicable
...
However, tenant\_id and store\_id must be explicit for store-scoped operational data.
...
Tenant-scoped tables must include tenant\_id.
...
Store-scoped tables must include tenant\_id and store\_id.
...
12\. Which tables require tenant\_id?
13\. Which tables require tenant\_id and store\_id?
