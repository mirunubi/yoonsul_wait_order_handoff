...
- Runtime profile configuration screens must follow `docs/07000_admin_console/07080_Governance_Admin_Runtime_Profile_Configuration.md`.
...
- Support/break-glass boundary must follow `docs/07000_admin_console/07110_Boundary_Admin_Support_And_BreakGlass.md`.

## 8 App/API Projection Cross-Reference

Surface state visibility is defined in `docs/13000_app_api_projection/13060_Matrix_Surface_State_Visibility_And_Authority.md`.

Customer wording matrix is defined in `docs/13000_app_api_projection/13070_Matrix_Customer_Surface_State_Wording.md`.

Store/admin/support action authority is defined in `docs/13000_app_api_projection/13080_Matrix_Store_Admin_Support_Action_Authority.md`.
