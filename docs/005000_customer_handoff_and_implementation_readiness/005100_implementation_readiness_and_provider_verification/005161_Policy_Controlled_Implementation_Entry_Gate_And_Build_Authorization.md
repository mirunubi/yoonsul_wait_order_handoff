...
- `READY_FOR_STAGING_GATE`
- `READY_FOR_PRODUCTION_GATE`
- `BLOCKED`
- `REMOVED_FROM_SCOPE`

A feature must not jump directly from `DOCUMENTED_ONLY` to `IMPLEMENTATION_IN_PROGRESS`.
...
- `APPROVED_FOR_CONTROLLED_IMPLEMENTATION`
- `APPROVED_FOR_SANDBOX_ONLY`
- `APPROVED_FOR_STAGING_ONLY`
- `DENIED`
- `DEFERRED`
- `REMOVED_FROM_SCOPE`
- `REQUIRES_REVIEW`
...
- `REQUIRES_AUDIT_REVIEW`
- `REQUIRES_RELEASE_REVIEW`
...
Example:
    ...
    - Risk Level: Critical
    - Authorization Decision: APPROVED_FOR_DESIGN_ONLY
    ...
    ## 9. Release Gate Impact
    - Impact Level: CRITICAL_RELEASE_BLOCKER
    ...
    ## 10. Decision
    - Decision: APPROVED_FOR_DESIGN_ONLY
...
- any stale evidence must be marked `REQUIRES_RETEST`
