# 005410_Policy_Pilot_Incident_Retrospective_Blocker_Conversion_And_Next_Store_Learning
...
\- \`WAITING\_STORE\`
\- \`WAITING\_SUPPORT\`
\- \`WAITING\_LEGAL\_REVIEW\`
\- \`WAITING\_SECURITY\_REVIEW\`
\- \`DEFERRED\`
\- \`ACCEPTED\_RISK\`
\- \`RESOLVED\`
\- \`REJECTED\`
...
\- \`CONTINUE\_SAME\_SCOPE\`
\- \`CONTINUE\_WITH\_SCOPE\_REDUCTION\`
\- \`CONTINUE\_WITH\_SCOPE\_EXPANSION\`
\- \`PAUSE\_UNTIL\_BLOCKER\_RESOLVED\`
\- \`RETEST\_REQUIRED\`
\- \`MOVE\_TO\_NEXT\_STORE\`
\- \`ADD\_PROVIDER\_REVIEW\`
\- \`CHANGE\_HARDWARE\`
\- \`CHANGE\_TRAINING\`
\- \`CHANGE\_SUPPORT\_MODEL\`
\- \`CHANGE\_PRICING\_HYPOTHESIS\`
\- \`DEFER\_FRANCHISE\_LINKAGE\`
\- \`PREPARE\_PAID\_PILOT\`
\- \`STOP\_PILOT\`
