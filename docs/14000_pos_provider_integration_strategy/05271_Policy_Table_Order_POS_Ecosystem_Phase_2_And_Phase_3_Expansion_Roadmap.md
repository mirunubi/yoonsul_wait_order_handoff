# 05271_Policy_Table_Order_POS_Ecosystem_Phase_2_And_Phase_3_Expansion_Roadmap
...
PAYCO first-phase position:
    ...
    SECONDARY_PAYMENT_SMART_ORDER_CHANNEL
...
- local order Agent
- STORE_ID / SERVICE_ID based authorization
