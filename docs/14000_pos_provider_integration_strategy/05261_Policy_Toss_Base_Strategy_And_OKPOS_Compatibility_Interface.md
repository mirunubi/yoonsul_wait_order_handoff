# 05261_Policy_Toss_Base_Strategy_And_OKPOS_Compatibility_Interface
...
| -------- | ------ | ---- |
| Toss Place | PRIMARY_BASE | First implementation direction |
| OKPOS | REQUIRED_COMPATIBILITY | Existing-store compatibility path |
| PAYCO | SECONDARY_PAYMENT_CHANNEL | Payment/smart-order/login option |
| Smartro | PHASE2_INVESTIGATION | Later POS compatibility |
| KICC EasyPOS | PHASE2_INVESTIGATION | Later POS compatibility |
| NICE POS / NICE Payments | PHASE2_INVESTIGATION | Later payment/POS candidate |
| Small kiosk vendors | PHASE2_OR_STORE_SPECIFIC | Evaluate case by case |
| Direct hardware terminal | DEFERRED_CERTIFIED_LANE | Later certified integration |
