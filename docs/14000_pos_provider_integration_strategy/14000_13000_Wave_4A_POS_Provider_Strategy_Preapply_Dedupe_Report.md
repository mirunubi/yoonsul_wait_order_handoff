# 13000_14000_Wave_4A_POS_Provider_Strategy_Preapply_Dedupe_Report
...
| --- | --- | --- | --- |
| `13000_app_api_projection` | `13000_App_Api_Projection_Readme.md` | No | OK (title uses spaces: `# 13000 App Api Projection Readme`) |
...
| `05200_pos_payment_provider_and_kiosk_reuse` | `05200_POS_Payment_Provider_And_Kiosk_Reuse_Readme.md` | No | OK |
...
| --- | --- | --- | --- |
| `05255_Store_POS_Adoption_Strategy_OKPOS_Ledger_And_Toss_Kiosk_Combination_Assessment.md` | `14000` only | Yes (section 34) | Yes |
| `05260_Toss_Base_Strategy_And_OKPOS_Compatibility_Interface_Policy.md` | `14000` only | Yes (section 34) | Yes |
...
- **Overlap with POS provider strategy:** Minimal — `13120_Integration_Status_Projection_Boundary.md` references integration status conceptually but is not a provider strategy document.
...
- **After dedupe:** Should contain **16 unique strategy files** + **new numbered README** (recommended `14000_POS_Provider_Integration_Strategy_Readme.md`).
...
| 4 | Create `14000_POS_Provider_Integration_Strategy_Readme.md` during Wave 4-B? | **Yes** |
...
2. Create `14000_POS_Provider_Integration_Strategy_Readme.md` in `14000`.
