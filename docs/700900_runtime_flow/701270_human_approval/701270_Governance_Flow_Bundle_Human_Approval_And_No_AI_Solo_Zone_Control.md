...
| Preceded By | 701260_Audit_Flow_Bundle_AI_Assisted_Implementation_Governance.md |
...
|---|---:|---|
| flow_bundle_id | Yes | Example: `701000` |
...
This governance document depends on the following 700900 Runtime Flow Registry documents.

| File | Purpose |
|---|---|
| 700900_Index_Runtime_Flow_Bundle_Registry.md | Top-level registry and implementation principle |
| 701000_Flow_POS_Gateway_Approval_To_Audit_Ledger_And_Reconciliation.md | Approval-to-audit base flow |
| 701010_Flow_POS_Gateway_Cancel_Refund_Recovery_And_Audit.md | Cancel/refund recovery flow |
| 701020_Flow_POS_Gateway_Timeout_Retry_DLQ_And_Replay.md | Retry/DLQ/replay control flow |
| 701030_Flow_POS_Gateway_Store_Offline_Local_Ledger_And_Resync.md | Offline local ledger and resync flow |
| 701040_Flow_POS_Gateway_Webhook_Inbound_Verification_And_Event_Normalization.md | Webhook trust-boundary flow |
...
| 701210_Template_Flow_Bundle_Claude_Code_Handoff_Prompt.md | Claude Code handoff prompt |
| 701220_Template_Flow_Bundle_Cursor_IDE_Assist_Prompt.md | Cursor assist prompt |
...
| 701260_Audit_Flow_Bundle_AI_Assisted_Implementation_Governance.md | AI-assisted implementation audit governance |
