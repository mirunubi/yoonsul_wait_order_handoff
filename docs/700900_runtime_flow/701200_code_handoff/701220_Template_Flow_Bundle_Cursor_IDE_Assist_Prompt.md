...
- Related Handoff Template: 701210_Template_Flow_Bundle_Claude_Code_Handoff_Prompt.md
- Status: Draft
...
|---|---:|---|
| `{{FLOW_BUNDLE_ID}}` | Yes | Flow Bundle number, for example `701000` |
...
```text
Inspect the listed files only and tell me whether the implementation matches Flow Bundle 701020 timeout/retry/DLQ/replay rules. Do not edit anything.
```
...
```text
Compare the existing tests with the Flow Bundle 701040 webhook verification test coverage map. List missing tests only. Do not write code yet.
```
...
```text
Review this diff against Flow Bundle 701000. Identify any scope creep, forbidden edits, missing tests, or missing evidence outputs. Do not modify files.
```
...
Approved Flow Bundle:
- Flow Bundle ID: 701020
- Flow Bundle File: 701020_Flow_POS_Gateway_Timeout_Retry_DLQ_And_Replay.md
- Related Index: 700900_Index_Runtime_Flow_Bundle_Registry.md
- MD Dependency Graph: 701100_Matrix_Flow_To_MD_Dependency_Graph.md
- Runtime Flow Diagram: 701020 section 6
- Module Impact Map: 701110_Matrix_Flow_To_Module_Implementation_Map.md
- Test Coverage Map: 701120_Matrix_Flow_To_Test_Coverage_Map.md
...
Task requested:
Inspect the existing retry and DLQ tests. List missing test cases against Flow Bundle 701020. Do not edit files.
