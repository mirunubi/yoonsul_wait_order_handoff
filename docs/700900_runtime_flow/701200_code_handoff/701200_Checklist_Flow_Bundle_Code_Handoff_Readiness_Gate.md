...
|---|---:|---|
| 701000_Flow_POS_Gateway_Approval_To_Audit_Ledger_And_Reconciliation.md | Yes | Tech Lead / Audit Owner |
| 701010_Flow_POS_Gateway_Cancel_Refund_Recovery_And_Audit.md | Yes | Tech Lead / Audit Owner |
| 701020_Flow_POS_Gateway_Timeout_Retry_DLQ_And_Replay.md | Yes | Tech Lead / QA Lead |
| 701030_Flow_POS_Gateway_Store_Offline_Local_Ledger_And_Resync.md | Yes | Tech Lead / Store Runtime Owner |
| 701040_Flow_POS_Gateway_Webhook_Inbound_Verification_And_Event_Normalization.md | Yes | Security Owner / Integration Owner |
| 701050_Flow_POS_Gateway_Settlement_Dispute_And_Evidence_Export.md | Yes | Settlement Owner / Audit Owner |
| 701100_Matrix_Flow_To_MD_Dependency_Graph.md | Yes | Documentation Owner |
| 701110_Matrix_Flow_To_Module_Implementation_Map.md | Yes | Tech Lead |
| 701120_Matrix_Flow_To_Test_Coverage_Map.md | Yes | QA Lead |
...
| 701000_Flow_POS_Gateway_Approval_To_Audit_Ledger_And_Reconciliation.md | Approval and reconciliation flow |
| 701010_Flow_POS_Gateway_Cancel_Refund_Recovery_And_Audit.md | Cancel/refund recovery flow |
| 701020_Flow_POS_Gateway_Timeout_Retry_DLQ_And_Replay.md | Timeout/retry/DLQ/replay flow |
...
| 701050_Flow_POS_Gateway_Settlement_Dispute_And_Evidence_Export.md | Settlement/dispute/evidence export flow |
...
|---:|---|---|
| 701210 | 701210_Template_Flow_Bundle_Claude_Code_Handoff_Prompt.md | Standard prompt template for Claude Code handoff |
| 701220 | 701220_Template_Flow_Bundle_Cursor_IDE_Assist_Prompt.md | Cursor IDE assist prompt template |
| 701230 | 701230_Runbook_Flow_Bundle_Code_Review_And_Diff_Control.md | Diff control and review runbook |
| 701240 (file not yet created — pending Evidence packet gate) | 701240_Evidence_Flow_Bundle_Implementation_Review_Packet.md (file not yet created — pending Evidence packet gate) | Evidence packet template after implementation |
