...
Defines guardrails that prevent runtime work without explicit approval.
...
- Documentation-only readiness artifact for the `Safety / No-Runtime-Without-Approval Guardrail` group.
