...
The previous artifact `10711 Bunsik Gimbap Tteokbokki Snack Menu Taxonomy Seed Registry And AI Classification Dictionary Policy` expanded bunsik menus with shorthand restoration, topping/sari binding, set parsing, group-order behavior, and fast track readiness.
...
- `10713 Salad Healthy Food Poke Yogurt Menu Taxonomy Policy`
...
- `10716 Cafe Pickup Barista Station Fast Track SOP`
