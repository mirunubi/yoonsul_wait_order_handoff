# 10718_Legal_Notice_Master_Data_Table_Static_Specification_Policy

## 1. Purpose

This document defines the static table specification for storing the Catch Menu legal notice master pool in the database.

The previous document `10717 Legal Notice Master Data Usage Flow And Runtime Retrieval Governance Policy` defined how legal notice master data is retrieved, activated, displayed, acknowledged, versioned, and referenced by support/dispute workflows.
