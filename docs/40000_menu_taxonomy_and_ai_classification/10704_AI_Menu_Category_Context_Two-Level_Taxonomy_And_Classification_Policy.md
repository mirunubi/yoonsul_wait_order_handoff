# 10704_AI_Menu_Category_Context_Two-Level_Taxonomy_And_Classification_Policy

## 1. Purpose

This document defines the AI Menu Category Context, Two-Level Food Business Taxonomy, and Menu Classification Policy.

The previous artifact `10703 AI Menu Intake Parsing Interactive Editor Fast Track Attribute And Live Deployment Boundary Policy` defined how menu images, PDFs, text lists, and menu boards may be uploaded, parsed by AI, reviewed by humans, validated, approved, versioned, deployed, and rolled back.
