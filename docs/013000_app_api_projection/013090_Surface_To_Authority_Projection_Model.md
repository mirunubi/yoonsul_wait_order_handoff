...
- UI surface-to-authority composition is refined in `docs/17000_ui_screen_composition/017080_UI_Surface_To_Authority_Composition_Model.md`.
- UI button/status governance is defined in `docs/17000_ui_screen_composition/017100_Governance_Action_Button_And_Status_Badge.md`.
