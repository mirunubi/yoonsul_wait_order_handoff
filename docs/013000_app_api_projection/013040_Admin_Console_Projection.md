...
Projected groups follow `docs/07000_admin_console/007040_Admin_Screen_Inventory_And_Navigation_Model.md`:
...
Admin Console projection must follow `docs/07000_admin_console/007070_Admin_Context_Navigation_And_Scope_Model.md` through `docs/07000_admin_console/007110_Boundary_Admin_Support_And_BreakGlass.md` for context navigation, runtime profile configuration, approval/disable, audit review, and support boundary.
