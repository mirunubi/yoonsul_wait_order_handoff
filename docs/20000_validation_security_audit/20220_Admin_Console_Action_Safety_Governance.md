# 20220 Admin Console Action Safety Governance
...
Aligns with `docs/07000_admin_console/07080_Admin_Runtime_Profile_Configuration_Governance.md` and related admin governance docs at console level.
