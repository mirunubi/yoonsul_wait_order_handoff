...
## Purpose
This document defines the cross-system reuse between customer center and catch menu for the Cross-System Reuse Between Customer Center And Catch Menu group in Batch 7H.
