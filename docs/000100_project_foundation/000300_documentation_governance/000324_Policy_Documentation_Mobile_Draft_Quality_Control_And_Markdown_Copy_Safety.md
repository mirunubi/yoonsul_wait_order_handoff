...
Example:
    ...
    GOOD:
        ...
        SUPABASE_ANON_KEY=replace_with_dummy_key
...
If numbering uncertainty exists, mark the document as `NEEDS_NUMBER_REVIEW` during PC import.
...
If any item fails, mark as `NEEDS_COPY_REVIEW`.
...
2. Mark draft as `NEEDS_COPY_REVIEW`.
