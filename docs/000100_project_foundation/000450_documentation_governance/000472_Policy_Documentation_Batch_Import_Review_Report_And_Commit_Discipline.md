# 000472_Policy_Documentation_Batch_Import_Review_Report_And_Commit_Discipline
...
Recommended batch id format:
    ...
    DOC_IMPORT_YYYYMMDD_NN

Example:

    DOC_IMPORT_20260612_01
...
Recommended filename:
    ...
    DOC_IMPORT_YYYYMMDD_NN_Review_Report.md

Example:

    DOC_IMPORT_20260612_01_Review_Report.md
...
Recommended template:
    ...
    # DOC_IMPORT_YYYYMMDD_NN Review Report
...
- `IMPORTED_TO_REPO`
- `IMPORTED_IN_BATCH_DOC_IMPORT_YYYYMMDD_NN`
...
Recommended commit message style:
    ...
    docs: import mobile drafts batch DOC_IMPORT_YYYYMMDD_NN

    docs: normalize filenames for security foundation docs

    docs: move POS KDS security docs to pos_kds folder
...
Emergency import should go to incoming folder and be marked `NEEDS_REVIEW`.
