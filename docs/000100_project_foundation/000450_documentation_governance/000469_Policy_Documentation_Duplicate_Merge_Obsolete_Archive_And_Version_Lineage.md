# 000469_Policy_Documentation_Duplicate_Merge_Obsolete_Archive_And_Version_Lineage
...
\- \`MERGE\_CANDIDATE\`
\- \`ARCHIVE\_CANDIDATE\`
\- \`KEEP\_BOTH\_WITH\_CLARIFICATION\`
...
or:
    ...
    {document\_number}\_{title}\_OBSOLETE.md

or:

    {document\_number}\_{title}\_MERGED\_TO\_{target\_number}.md
