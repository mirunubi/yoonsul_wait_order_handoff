...
> ⚠️ **재도출 범위 — 2026-08-29 추가 기록**
>
> ```text
> 재도출함     S-5   601702 §1.27 · §1.28 원문 확인 — §3.1
> 재도출 안 함  S-10  Cowork F-2 의 제품 · DB 경계 전제를
>                     독립 검증하지 않고 승계했다
> ```
>
> ⚠️ **§0 의 「재도출했다」는 전건이 아니라 일부였다.**
>
> **다만 `S-10` 을 그 이유로 기각하지 않는다.**
> **Cowork `F-2` 의 「YS-OS = 별도 제품 · 별도 DB」 전제는
> Human 이 확정한 제품 경계와 일치한다.**
>
> **`S-10` 의 처분은 `601808` §2 를 따른다.**
