...
**원문이 링크한 산출물 2건이 저장소 밖에 있었다.**

| 편입 번호 | 원 파일 | 내용 |
|---|---|---|
| `601920` | `security-definer-inventory.md` | `SECURITY DEFINER` 함수 인벤토리 — `C-01` 근거 |
| `601921` | `table-isolation-inventory.md` | 테이블 격리 실측 |

> ⚠️ **§1 원문의 링크는 원 경로 그대로 보존한다.**
> **거버넌스 체커가 깨진 링크로 잡으나 원문 보존이 우선이다.**
