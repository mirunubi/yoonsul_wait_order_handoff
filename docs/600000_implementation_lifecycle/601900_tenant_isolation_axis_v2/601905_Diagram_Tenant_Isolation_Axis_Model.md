...
**`601902` `TI-1`~`TI-11` 을 모델로 옮긴 것이며 구현 설계가 아니다.**
...
**11건 전건 기록. 미표현 2건(`TI-1` · `TI-11`)은 사유를 적었다.**

## §9 근거 문서 목록 (`000701` §46)

| 문서 | 인용 | 지위 |
|---|---|---|
| `601902_Register_Stage1_Business_Rules.md` | `TI-1`~`TI-11` · `HD-0-A-2R-1`~`9` · `OQ-1`~`OQ-3` — 모델의 유일한 선언 출처 | ACTIVE |
