...
`010650` 자동 containment · `601913` `R2-3` · `601901` §9.1.2 (`010630` §6 · §28).

> ⚠️ **`AUTHORITY_PARTIAL_ALLOWED` 는 `601901` §9.1.2 (`010630` §6)가
...
> `601913` `R2-2` · `601901` §9.3.2 (`010660` §6).
...
> ⚠️ **`010640` §5 는 초판 작성 시 `601901` 절 구조 목록에만 있었다.**
> **2026-09-06 원문 채록으로 보강됐다** — `601916` `F-4` · `601917` §4.
...
> ⚠️ **`601901` §5.2 (`010004` §19)가 이 항목을 채록했으나 초판이 옮기지 않았다.**
...
> ⚠️ **`010004` §26 은 초판 작성 시 `601901` 절 구조 목록에만 있었다.**
> **2026-09-06 원문 채록으로 보강됐다** — `601916` `F-4` · `601917` §4.
...
**근거** — `601909` `T3-1` · `010004` §7 · `601901` §5.2 (`010004` §7).
...
`000190` §3 · §8 · §10 · §17 · §27 · `601702` §1.12 · §1.33 · `601901` §7 · §9 · §10.2.
...
> ⚠️ **`601702` §1.12 가 「같은 실체가 두 시스템에서 다른 정체성을 가진다」를
> 이미 선언했다.**
>
> **`TI-15.3` 이 든 사유가 그 절의 주제다.**
>
> **초판 작성 시 `601901` 이 그 절을 채록하지 않아 인용하지 못했다** —
> `601915` `BR3-I8`.
> **2026-09-06 `601901` §10.2 에 보강 채록됐고 근거로 추가했다.**
...
| OQ-7 | **해소 (2026-09-06)** — 행 번호 인용을 `601901 §N.N (원천 §M)` 형식으로 교체했다. 채록 보강이 행을 밀어도 다시 깨지지 않는다 |
...
| `601702_Register_Stage1_Business_Rules.md` | 선언 45건 — 상위 근거. §1.27 · §1.28 은 `TI-12` · §1.12 · §1.33 은 `TI-15` | ACTIVE |
