...
| **0-A 재수행** Tenant/LegalEntity/HQ/Store | `601700_operational_authority_foundation_v2` | **1단계** (업무규칙 선언) | 진행중 — §48 증거수집 완료(`601701` 5개 대상 A~E, `601703` HQ/HR 5개 대상 A단계). 1단계 선언 18건 확정(`601702` §1.1~§1.18). Session·Role·Permission 선언 미완 | 2026-08-13 |
...
| **0-A 재수행** | Tenant / LegalEntity / HQ / Store — `601500` 권위보류에 따른 재시작 | **진행중 (2026-08-13~)** — `601700`. 601500을 답안지로 사용하지 않는다(`600020` §2) |
...
| **0-B** | Staff identity / session | ⛔ **HOLD** — 0-A 권위보류로 선행조건 소멸(`600020` §1.2) |
