# 600534_ChangeContract_Mark_Payment_Uncertain_Overload.md
...
This mirrors the already-accepted `600480_confirm_payment_from_provider_overload_ambiguity` structure:
...
5. Run `600533_TestPlan_Mark_Payment_Uncertain_Overload.md` §0–§6.
