# 600533_TestPlan_Mark_Payment_Uncertain_Overload.md
...
1. Confirm `600534_ChangeContract_Mark_Payment_Uncertain_Overload.md` Human Approval checkboxes are checked.
...
select catchmenu_payment.mark_payment_uncertain(
  ...
  p_correlation_id := 'test-600533-ambiguity'
);
```
...
select catchmenu_payment.mark_payment_uncertain(
  ...
  p_uncertain_reason := '600533 E2E test',
  p_correlation_id := 'test-600533-e2e'
);
```
...
This is an accepted carried-forward defect, not a failure of this workpacket. See §7 Open Items in `600532_Logic_Mark_Payment_Uncertain_Overload.md`.
...
Confirmed source fact from `600532_Logic_Mark_Payment_Uncertain_Overload.md`:
