...
`009030_Conceptual_Entity_Master.md` is the conceptual entity master.

`009040_State_And_Event_Ownership_Model.md` is the state/event ownership model.

`009050_Audit_Recovery_Event_Lineage_Model.md` is audit/recovery lineage.

`009060_Implementation_Deferred_Data_Model_Boundary.md` is the implementation-deferred boundary.
