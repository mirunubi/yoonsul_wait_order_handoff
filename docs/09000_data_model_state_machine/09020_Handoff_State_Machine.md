...
Entity definitions are consolidated in `docs/09000_data_model_state_machine/09030_Conceptual_Entity_Master.md`.

State/event ownership is defined in `docs/09000_data_model_state_machine/09040_State_And_Event_Ownership_Model.md`.
