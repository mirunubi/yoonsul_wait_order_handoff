...
## Purpose
This document defines the boundary that keeps deployment planning separate from runtime implementation for the Deployment Operations Governance group in Batch 7K.
