# 000006_Plan_Top_Level_Folder_Consolidation
...
> **04900 band correction applied:** `13000_security_runtime_test_catalog` moved to `04900_security_runtime_test_catalog`; archive subfolder renamed to `04999_archive_duplicate_review`; README renamed to `04900_Readme_Security_Runtime_Test_Catalog.md` (2026-06-09).
...
| --- | --- | --- |
| `05106_Policy_Test_Catalog_Lane_Index_Readiness_Check_And_Evidence_Handoff.md` | `05100_implementation_readiness_and_provider_verification`, `13000_security_runtime_test_catalog/archive_duplicate_review` | **archived Wave 4-B** — canonical under `05000/05100` |
...
| `05120_Policy_Runtime_Owner_Registry_And_Implementation_Responsibility_Matrix.md` | `05100_implementation_readiness_and_provider_verification`, `13000_security_runtime_test_catalog/archive_duplicate_review` | **archived Wave 4-B** — canonical under `05000/05100` |
...
| `05140_Policy_Blocker_Register_Waiver_Deferred_Scope_And_Risk_Acceptance.md` | `05100_implementation_readiness_and_provider_verification`, `13000_security_runtime_test_catalog/archive_duplicate_review` | **archived Wave 4-B** — canonical under `05000/05100` |
| `05150_Policy_Toss_POS_Official_Verification_Checklist_And_Integration_Evidence.md` | `05100_implementation_readiness_and_provider_verification`, `14000_pos_provider_integration_strategy/archive_duplicate_review` | **archived Wave 4-B** — canonical under `05000/05100` |
| `05160_Policy_Controlled_Implementation_Entry_Gate_And_Build_Authorization.md` | `05100_implementation_readiness_and_provider_verification`, `14000_pos_provider_integration_strategy/archive_duplicate_review` | **archived Wave 4-B** — canonical under `05000/05100` |
| `05170_Policy_PAYCO_POS_Verification.md` | `05100_implementation_readiness_and_provider_verification`, `14000_pos_provider_integration_strategy/archive_duplicate_review` | **archived Wave 4-B** — canonical under `05000/05100` |
| `05180_Policy_Provider_Priority_Openness.md` | `05100_implementation_readiness_and_provider_verification`, `14000_pos_provider_integration_strategy/archive_duplicate_review` | **archived Wave 4-B** — canonical under `05000/05100` |
| `05190_Policy_MVP_Provider_Cutline_And_Phase_2_POS_Expansion_Deferral.md` | `05100_implementation_readiness_and_provider_verification`, `14000_pos_provider_integration_strategy/archive_duplicate_review` | **archived Wave 4-B** — canonical under `05000/05100` |
| `05205_Policy_POS_Payment_Provider_Document_Folder_Grouping_And_Kiosk_Reuse.md` | `05200_pos_payment_provider_and_kiosk_reuse`, `14000_pos_provider_integration_strategy/archive_duplicate_review` | **archived Wave 4-B** — canonical under `05000/05200` |
| `05210_Policy_Mini_Kiosk_And_Kiosk_Provider_Integration_Module_Boundary.md` | `05200_pos_payment_provider_and_kiosk_reuse`, `14000_pos_provider_integration_strategy/archive_duplicate_review` | **archived Wave 4-B** — canonical under `05000/05200` |
| `05220_Policy_Mini_Kiosk_Payment_Flow_State_And_Recovery_Boundary.md` | `05200_pos_payment_provider_and_kiosk_reuse`, `14000_pos_provider_integration_strategy/archive_duplicate_review` | **archived Wave 4-B** — canonical under `05000/05200` |
| `05230_Policy_Mini_Kiosk_Session_Identity_Device_Trust_And_Customer_Context_Boundary.md` | `05200_pos_payment_provider_and_kiosk_reuse`, `14000_pos_provider_integration_strategy/archive_duplicate_review` | **archived Wave 4-B** — canonical under `05000/05200` |
| `05240_Policy_MVP_Provider_Cutline_Revision_Toss_OKPOS_First_Phase_And_PAYCO_Payment_Channel.md` | `05200_pos_payment_provider_and_kiosk_reuse`, `14000_pos_provider_integration_strategy/archive_duplicate_review` | **archived Wave 4-B** — canonical under `05000/05200` |
| `05250_Policy_OKPOS_OKDC_Integration_Implementation_Approach_And_Test_Mapping.md` | `05200_pos_payment_provider_and_kiosk_reuse`, `14000_pos_provider_integration_strategy/archive_duplicate_review` | **archived Wave 4-B** — canonical under `05000/05200` |
...
docs/
  04000_store_runtime_pos_kds_operations/
    04000_Readme_Store_Runtime_POS_KDS_Operations.md          [CREATE]
  ...
  05000_customer_handoff_and_implementation_readiness/
    05000_Readme_Customer_Handoff_And_Implementation_Readiness.md  [CREATE]
  ...
  40000_menu_taxonomy_and_ai_classification/                [LEAVE]
    40000_Readme_Menu_Taxonomy_And_AI_Classification.md       [EXISTS]
