# 11010_Boundary_POS_Payment_Printer_Integration
...
- POS API truth boundary is refined in `docs/11000_integration_boundary/11020_Boundary_POS_API_Integration_Truth.md`.
- Printer/Store Agent boundary is refined in `docs/11000_integration_boundary/11030_Boundary_Printer_And_Store_Agent.md`.
- Payment/financial truth boundary is refined in `docs/11000_integration_boundary/11040_Boundary_Payment_And_Financial_Truth.md`.
- Manual POS input/reconciliation boundary is refined in `docs/11000_integration_boundary/11050_Boundary_Manual_POS_Input_And_Reconciliation.md`.
- Failure/retry/recovery boundary is refined in `docs/11000_integration_boundary/11060_Boundary_Integration_Failure_Retry_And_Recovery.md`.
