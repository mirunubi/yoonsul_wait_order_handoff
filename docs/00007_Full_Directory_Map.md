...
`15000~16999` is reserved for membership / loyalty / coupon / point documentation, but `docs/15000_membership_loyalty/` does not exist yet.

`17000~19999` is reserved for UI screen composition / wording / wireframe / design documentation, but `docs/17000_ui_screen_composition/` does not exist yet.

`28000~29999` is the active future expansion band. `docs/28000_future_expansion/` is the current future expansion folder.
