# 004980_Policy_Tenant_Store_RLS_Access_Control_Test_Catalog
...
\- Request payload includes tenant\_id for Tenant B.

Action:

\- Actor sends request with modified tenant\_id.

Expected result:

\- Server-side context validation rejects request.
\- Payload tenant\_id is not trusted.
