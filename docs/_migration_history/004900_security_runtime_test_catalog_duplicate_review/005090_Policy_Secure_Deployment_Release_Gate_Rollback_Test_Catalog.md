# 005090_Policy_Secure_Deployment_Release_Gate_Rollback_Test_Catalog
...
\- Audit records environment, release id, actor/service, started\_at, completed\_at, result, and rollback plan reference.
