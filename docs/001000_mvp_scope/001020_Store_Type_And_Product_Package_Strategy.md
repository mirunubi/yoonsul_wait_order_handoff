...
- Store-type adoption sequence is consolidated in `docs/01000_mvp_scope/001060_MVP_Store_Type_Adoption_Sequence.md`.
- Package/feature flag boundary is consolidated in `docs/01000_mvp_scope/001050_Boundary_MVP_Package_And_Feature_Flag.md`.
- Full OS and platform payment remain non-default MVP paths.

## 13 Runtime Model Cross-Reference

Package names must align with `docs/03000_saas_runtime/003010_Tenant_Store_Runtime_And_Package_Model.md`.
