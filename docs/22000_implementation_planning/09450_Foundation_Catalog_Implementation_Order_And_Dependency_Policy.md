...
After controlled handoff and work order rules are defined in `09440`, the next step is to define the safe order in which foundation catalogs should be prepared.
