# 22380_Policy_External_Menu_Projection_Redtable_Partner_Package_Planning
...
Customer identity from 자리찜 or internal membership must not be shared externally by default.
